...
> 🧭 **Tu ne connais pas encore les noms ?** [**Par où commencer**](https://arquosdev.github.io/design-system/?path=/story/prise-en-main-par-o%C3%B9-commencer--chercher) — cherchez par ce que vous voulez *faire*. La recherche de Storybook ne lit pas les mots-clés des fiches ; cette page, si.

> 👀 **Tu veux le regarder ?** [**La vitrine**](https://arquosdev.github.io/design-system/) — rangée en quatre temps : **Prise en main**, **Fondations**, **Composants**, **Modèles**. En local : `npm run storybook`.

> 🧭 **Tu écris un écran ?** Commence par les [**principes de design**](https://arquosdev.github.io/design-system/?path=/docs/fondations-principes-de-design--docs) — quatre règles qui disent comment décider — puis les [**règles d'écran**](https://arquosdev.github.io/design-system/?path=/docs/fondations-r%C3%A8gles-d-%C3%A9cran--docs), qui disent ce que ça donne chez nous.
...
| `npm test` | une règle métier cassée — les `<nom>.logic.ts` sont testés sans navigateur |
...
- **v1.27.0** (août 2026) — **La vitrine change de plan** : Prise en main → Fondations → Composants → Modèles, sur le modèle d'Atlassian. Quatre fondations qui manquaient (icônes, élévation, mouvement, empilement), une page « Installer », et l'interface habillée aux tokens du produit.
- **v1.26.0** (août 2026) — **22 tests sur la logique métier**, un statut de composant enfin défini, et les chemins de `remplace` vérifiés — ce qui a révélé 14 entrées fantômes créées par des virgules.
